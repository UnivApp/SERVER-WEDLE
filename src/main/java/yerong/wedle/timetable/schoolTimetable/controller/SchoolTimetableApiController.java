...
public class SchoolTimetableApiController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "학교 시간표 조회 성공"),
                    @ApiResponse(responseCode = "404", description = "회원을 찾을 수 없음"),
                    @ApiResponse(responseCode = "404", description = "학교 시간표 찾을 수 없습니다."),
            }
    )
    @GetMapping()
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "학교 시간표 생성 성공"),
                    @ApiResponse(responseCode = "404", description = "회원을 찾을 수 없음"),
            }
    )
    @PostMapping("/create")
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "학교 시간표 비우기 성공"),
                    @ApiResponse(responseCode = "403", description = "권한이 없습니다."),
                    @ApiResponse(responseCode = "404", description = "회원을 찾을 수 없음"),
                    @ApiResponse(responseCode = "404", description = "학교 시간표를 찾을 수 없습니다."),
            }
    )
    @DeleteMapping("/clear")
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "회원을 찾을 수 없음"),
                    @ApiResponse(responseCode = "404", description = "학교 시간표를 찾을 수 없습니다."),
                    @ApiResponse(responseCode = "409", description = "해당 교시에 스케줄이 이미 존재합니다."),
            }
    )
