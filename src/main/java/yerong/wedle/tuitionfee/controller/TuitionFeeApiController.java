...
public class TuitionFeeApiController {
    ...
    public List<TuitionFeeResponse> getTuitionFeesByType(@PathVariable Long universityId) {
        return tuitionFeeService.getTuitionFeesByType(universityId);
    }
    ...
    public TuitionFeeResponse getAverageTuitionFee(@PathVariable Long universityId) {
        return tuitionFeeService.getAverageTuitionFee(universityId);
    }
}
